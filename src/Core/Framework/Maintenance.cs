...
namespace Outpost31.Core.Framework
{
    ...
    /// <include file='XmlDoc/Outpost31.Core.Framework_doc.xml' path='Outpost31.Core.Framework/Cs[@name="Maintenance"]/Maintenance/*'/>
    public static class Maintenance
    {
        ...
        /// <remarks>Verifies the Tingen framework components.</remarks>
        ...
        /// <remarks>Deletes the directory, then recreates it.</remarks>
        ...
        /// <remarks>Verifies the directory exists, and creates it if it does not.</remarks>
        ...
        /// <remarks>Verifies the directories exist, and creates them if they do not.</remarks>

...
namespace Outpost31.Core.Configuration
{
    ...
    /// <include file='XmlDoc/Outpost31.Core.Configuration_doc.xml' path='Outpost31.Core.Configuration/Cs[@name="ConfigSettings"]/ConfigSettings/*'/>
    public class ConfigSettings
    {
        /// <summary>Determines the available Tingen web service functionality.</summary>
        /// <include file='XmlDoc/Outpost31.Core.Configuration_doc.xml' path='Outpost31.Core.Configuration/Cs[@name="ConfigSettings"]/TingenMode/*'/>
        public string TingenMode { get; set; }

        /// <summary>Determines the available Open Incident Module functionality.</summary>
        /// <include file='XmlDoc/Outpost31.Core.Configuration_doc.xml' path='Outpost31.Core.Configuration/Cs[@name="ConfigSettings"]/ModOpenIncidentMode/*'/>
        ...
        /// <include file='XmlDoc/Outpost31.Core.Configuration_doc.xml' path='Outpost31.Core.Configuration/Cs[@name="ConfigSettings"]/BuildDefaultObject/*'/>
        ...
        /// <include file='XmlDoc/Outpost31.Core.Configuration_doc.xml' path='Outpost31.Core.Configuration/Cs[@name="ConfigSettings"]/Load/*'/>
